  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        {/* Logo above brand name with glow */}
        <div className="mb-4">
        ...
        <div className="mb-8">
          ...
          <div className="hidden md:grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <div className="bg-slate-800/40 backdrop-blur-sm border border-teal-500/20 rounded-lg p-6 hover:border-teal-400/40 transition-all duration-300 text-center">
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm border border-blue-500/20 rounded-lg p-6 hover:border-blue-400/40 transition-all duration-300 text-center">
            ...
            <div className="bg-slate-800/40 backdrop-blur-sm border border-emerald-500/20 rounded-lg p-6 hover:border-emerald-400/40 transition-all duration-300 text-center">
